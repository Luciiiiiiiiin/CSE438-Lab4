...
class MovieDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let shareButton = UIBarButtonItem(image: UIImage(systemName: "square.and.arrow.up"), style: .plain, target: self, action: #selector(shareMovieDetails))
